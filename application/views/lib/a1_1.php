<head>
	...
	<script type="text/javascript">
		/*$(document).ready(function(){
			$("#bt1").click(function(){
				var name = $("#name").val();
				var publishing = $("#select_1").val();
				var date = $("#date").val();
				var book_class = $("#select_2").val();
				alert(name+publishing+date+book_class);
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="right , col-12 col-sm-8">
					<form method="post" action="a1_2" enctype="multipart/form-data">
						...
						<p><input type="radio" name="radio" checked>有效
							<input type="radio" name="radio">無效</p>
						<button id = "bt1" type="submit" >送出</button>
					</form>
				</div>
			</div>
		</div>
